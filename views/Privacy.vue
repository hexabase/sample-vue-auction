    ...
    <section class="policy">
      <div class="content">
        <section class="policy_section">
          ...
          <p class="policy_lead">
            SYZYGY株式会社（以下「当社」という）は、企業活動を行う上で、個人情報を適切に取り扱うことは当社の社会的責務であると考えます。当社ではこの責務を全うするために、以下のとおり個人情報保護方針を定め、個人情報保護の管理体制を確立し、企業として責任のある対応を実現するものとします。
          </p>
        ...
        <section class="policy_section">
          ...
          <dl class="policy_dlist">
            ...
            <dd>
              ...
              個人情報管理責任者<br />
              TEL：03-6450-6068<br />
              E-mail：info@syzygy-music.com<br />
